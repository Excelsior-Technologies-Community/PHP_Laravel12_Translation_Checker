...
<body class="bg-gray-100">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end flex-wrap gap-2">
                    ...
                    <button onclick="checkTranslations()"
                    ...
                    <a href="{{ route('translations.history') }}"
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div id="results" class="p-6">
                <p class="text-gray-500 text-center">
                    Select a locale and click "Check Now" to view missing translations
                </p>
            </div>
    ...
    <script>
        ...
        function displayResults(data) {
            ...
            if (data.missing_count === 0) {
                ...
                ✅ All translations complete for ${data.locale.toUpperCase()}
            </div>`;
    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3">Suggested Value</th>
    ...
    `;
            ...
            <tr class="border-b">
                ...
                <td class="px-6 py-4">${item.suggested_value}</td>
        ...
        function exportTranslations() {
            ...
            if (!locale) {
                alert('Please select locale first');
                return;
            }

            window.location.href =
                "{{ route('translations.export') }}?locale=" + locale;
        }
